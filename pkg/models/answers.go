...
func (answerL) LoadCreatedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAnswer interface{}, mods queries.Applicator) error {
	var slice []*Answer
	var object *Answer
	...
	if singular {
		...
		foreign.R.CreatedByAnswers = append(foreign.R.CreatedByAnswers, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.CreatedBy == foreign.ID {
				...
				foreign.R.CreatedByAnswers = append(foreign.R.CreatedByAnswers, local)
				break
			}
		}
	}
...
// SetCreatedByUser of the answer to the related item.
// Sets o.R.CreatedByUser to related.
// Adds o to related.R.CreatedByAnswers.
func (o *Answer) SetCreatedByUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	if related.R == nil {
		related.R = &userR{
			CreatedByAnswers: AnswerSlice{o},
		}
	} else {
		related.R.CreatedByAnswers = append(related.R.CreatedByAnswers, o)
	}
